...
class BlogPost extends Component{
    constructor(props){
        super(props);
        firebase.initializeApp(firebaseConfig); //inisiasi configutasi database
        this.state = {                    
            listArtikel: [] //variavle array yang digunakan untuk menyimapn data api
        }
    }
    ...
    componentDidUpdate(prevProps,prevState) {       // komponen untuk mengecek ketika compnent telah di-mount-ing, maka panggil API
